class t extends HTMLElement {
	...
	constructor(t) {
		super(), this.version = "2.5.4", this.config = {
	...
	async stampStyles(t) {
		...
		if (s.getAttribute("data-hash") !== e) {
			...
			return s.innerHTML = "", s.append(...r), await Promise.all(i.map((t => this.onload(t)))).catch((t => {
